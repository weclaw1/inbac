...
class Application(tk.Frame):
    def __init__(self, master=None):
        ...
        self.bind('z', self.save_next)
        self.bind('x', self.save)
    ...
    def load_image_from_file(self, filename):
        ...
        self.image_canvas.create_image(0, 0, anchor=NW, image=self.displayed_image)
    ...
    def get_selected_box(self):
        ...
        if fixed_aspect_ratio:
            ...
            return self.get_selection_box_for_aspect_ratio(selection_box, aspect_ratio)
        else:
            return 
